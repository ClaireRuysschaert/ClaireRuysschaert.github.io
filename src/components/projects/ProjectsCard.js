...
const ProjectsCard = ({ title, des, src, githubLink }) => {
  return (
    <div className="w-full p-6 xl:px-10 h-auto xl:py-10 rounded-lg shadow-shadowOne flex flex-col bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-gray-900 hover:gray-900 transition-colors duration-1000">
